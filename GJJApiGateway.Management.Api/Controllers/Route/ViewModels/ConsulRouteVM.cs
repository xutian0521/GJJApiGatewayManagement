namespace GJJApiGateway.Management.Api.Controllers.Route.ViewModels;

public class ConsulRouteVM
{
    ...
    public List<HostAndPortsVM> DownstreamHostAndPorts { get; set; }
    /// <summary>
    /// 下游服务地址和端口号
    /// </summary>
